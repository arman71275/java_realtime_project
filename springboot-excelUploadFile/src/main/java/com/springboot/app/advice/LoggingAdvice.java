  ...
  package com.springboot.app.advice;
  ...
  @Component public class LoggingAdvice {
  
  Logger log = LoggerFactory.getLogger(LoggingAdvice.class);
  
  @Pointcut(value = "execution(* com.springboot.app.*.*.*(..))") public void
  myPointCut() {
  ...
  ObjectMapper mapper = new ObjectMapper(); String methodName =
