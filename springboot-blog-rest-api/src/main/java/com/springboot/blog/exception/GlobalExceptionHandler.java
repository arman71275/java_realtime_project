...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ErrorDetails> hadleResourceNotFoundException(ResourceNotFound exception,WebRequest webRequest){
	...
	public ResponseEntity<ErrorDetails> hadleBlogAPIException(BlogAPIException exception,WebRequest webRequest){
		ErrorDetails errorDetails = new ErrorDetails(new Date(), exception.getMessage(), webRequest.getDescription(false));
	 ...
	 * hadleGlobalException(Exception exception,WebRequest webRequest){ ErrorDetails
	 ...
	 * hadleMethodArgumentNotValidException(MethodArgumentNotValidException
	...
	public ResponseEntity<ErrorDetails> hadleAccessDeniedException(AccessDeniedException exception,WebRequest webRequest){
		ErrorDetails errorDetails = new ErrorDetails(new Date(), exception.getMessage(), webRequest.getDescription(false));
